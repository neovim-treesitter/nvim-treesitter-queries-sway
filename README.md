# nvim-treesitter-queries-sway

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-sway/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-sway/actions/workflows/validate.yml)

Neovim tree-sitter queries for **sway**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-sway",
...
- [ ] Changes are scoped to `sway` — do not include files for other languages
